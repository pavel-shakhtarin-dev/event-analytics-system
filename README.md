...
Демонстрационный проект распределённой системы обработки событий с использованием паттерна **Transactional Outbox**, **Kafka Streams** для real-time аналитики и **ClickHouse** для хранения статистики.
...
![Архитектура проекта](gif/main.gif)
...
- ✅ Сохранение в Outbox-таблицу (Transactional Outbox Pattern)
...
![Spring Metrics](gif/spring-metrics.gif)
